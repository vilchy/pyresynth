...
class Line2D(Artist):
    ...
    zorder: int
    ind_offset: int
    def __init__(self, xdata, ydata, linewidth: Incomplete | None = ..., linestyle: Incomplete | None = ..., color: Incomplete | None = ..., gapcolor: Incomplete | None = ..., marker: Incomplete | None = ..., markersize: Incomplete | None = ..., markeredgewidth: Incomplete | None = ..., markeredgecolor: Incomplete | None = ..., markerfacecolor: Incomplete | None = ...,
                 markerfacecoloralt: str = ..., fillstyle: Incomplete | None = ..., antialiased: Incomplete | None = ..., dash_capstyle: Incomplete | None = ..., solid_capstyle: Incomplete | None = ..., dash_joinstyle: Incomplete | None = ..., solid_joinstyle: Incomplete | None = ..., pickradius: int = ..., drawstyle: Incomplete | None = ..., markevery: Incomplete | None = ..., **kwargs) -> None: ...
