...
class Artist:
    ...
    def set_sketch_params(self, scale: Incomplete | None = ..., length: Incomplete |
                          None = ..., randomness: Incomplete | None = ...) -> None: ...
    ...
    def set_clip_path(self, path, transform: Incomplete |
                      None = ...) -> None: ...
    ...
    def set(self, **kwargs): ...
    def findobj(self, match: Incomplete | None = ...,
                include_self: bool = ...): ...
...
class ArtistInspector:
    ...
    def pprint_setters(self, prop: Incomplete | None = ...,
                       leadingspace: int = ...): ...
    def pprint_setters_rest(self, prop: Incomplete |
                            None = ..., leadingspace: int = ...): ...
